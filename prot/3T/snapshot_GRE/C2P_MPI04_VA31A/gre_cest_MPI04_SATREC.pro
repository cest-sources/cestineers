  ...
  <ParamMap.""> 
  {
    ...
    <ParamMap."Properties"> 
    {
      ...
      <ParamMap."Queue"> 
      {
        ...
        <ParamString."ProtocolName">  { "APTw_SW"  }
      }
    }
  }
}
...
### ASCCONV BEGIN object=MrProtDataImpl@MrProtocolData version=63110002 converter=%MEASCONST%/ConverterList/Prot_Converter.txt ###
ulVersion	 = 	63110002
tSequenceFileName	 = 	"%CustomerSeq%\gre_cest"
tProtocolName	 = 	"APTw_SW"
tdefaultEVAProt	 = 	"%SiemensEvaDefProt%\Breast\Breast.evp"
lScanRegionPosTra	 = 	12.0
...
lSilentPeriod	 = 	0
dOverallImageScaleFactor	 = 	0.0230476525409
...
sSliceArray.asSlice[0].sPosition.dSag	 = 	-0.269523753768
sSliceArray.asSlice[0].sPosition.dCor	 = 	-3.79246925316
sSliceArray.asSlice[0].sPosition.dTra	 = 	-0.4544189695
...
sSpecPara.sVoI.sPosition.dTra	 = 	-12.0
sDiffusion.ulMode	 = 	1
...
sAAInitialOffset.SliceInformation.sPosition.dSag	 = 	-0.269523753768
sAAInitialOffset.SliceInformation.sPosition.dCor	 = 	-3.79246925316
sAAInitialOffset.SliceInformation.sPosition.dTra	 = 	11.5455810305
...
MrAdvancedReconstruction.sIterativeDenoising.lDenoisingStrength	 = 	4
MrAdvancedReconstruction.sIterativeDenoising.lEdgeEnhancementStrength	 = 	2
MrAdvancedReconstruction.sIterativeDenoising.ucEdgeEnhancementOn	 = 	0x1
### ASCCONV END ###
